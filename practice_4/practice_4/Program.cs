    ...
    internal class Program
    {
        public static void Main(string[] args)
        {
            Console.WriteLine(
                ...
                "Методом хорд вычислить с точностью е  корень уравнения f(x) = 0 (ниже, следом за уравнением f(x) = 0, дополнительно задан отрезок, содержащий корень): " +
                "\nб) х^2 — sin(5*PI): = 0, [0.5, 0.6];");

            double x0 = 0.5;
            double x1 = 0.6;
            double e = ReadDouble("Введите точность (1,01 для примера): ");
